...
angular.module('app').config(function ($provide) {
    $provide.decorator('$q', ['$delegate', function ($delegate) {
        ...
        /** todo: refactor
         * Resolved if at least one promises is resolved.
         * Rejected if all promises are reject.
         * @param promises
         * @returns {Promise}
         */
        $q.one = function (promises) {
            var deferred = $q.defer();
            if (angular.isArray(promises)) {
                var states = [];
                var results = [];
                var didAPromiseSucceed = false;
